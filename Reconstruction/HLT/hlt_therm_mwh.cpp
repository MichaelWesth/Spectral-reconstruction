...
// Calculates the effective epsilon
...
int main(int argc, char** argv)
{
    ...
    stringstream(argv[10])  >> kernel; // zero by standard, else therm
    // Three parameters for varying a paramter, from min to max, with num number of points.
    ...
    double scale = 1;
    analysis read;
    //Calculate average and covariance if lambda is non-zero
    if (lambda != 0) {        
